...
var DEFAULT_IMG = 'https://static.wikia.nocookie.net/d4f2425a-cfaf-41c2-8ecf-c78593720fb6';
...
function searchShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("".concat(BASE_URL, "/search/shows?q=").concat(term))];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
                    data = _a.sent();
                    return [2 /*return*/, data.map(function (obj) {
                            var _a;
                            return ({
                                id: obj.show.id,
                                name: obj.show.name,
                                summary: obj.show.summary,
                                image: ((_a = obj.show.image) === null || _a === void 0 ? void 0 : _a.medium) || DEFAULT_IMG
                            });
                        })];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log(id);
                    return [4 /*yield*/, fetch("".concat(BASE_URL, "/shows/").concat(id, "/episodes"))];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
